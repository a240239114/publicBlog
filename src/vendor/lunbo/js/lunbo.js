...
var xiangkuangWidth = $(".left").width();
$(".banner-box .img li img").width(xiangkuangWidth);
$(".banner-box .img li").width(xiangkuangWidth);
$(".banner-box").width(xiangkuangWidth);

var moveWidth = $(".banner-box .img li img").width();
...
$(".but-left").click(function () {
    ...
    i--;
    if (i == -1) {
        $('.banner-box .img').css('left', -(imgNum - 1) *moveWidth ); //用CSS进行图片位置变换，达到无缝拼接效果
        i = imgNum - 2;
    }
    oImg.stop().animate({
        left: -i * moveWidth
